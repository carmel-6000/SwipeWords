...
public abstract class DragItemAdapter<T, VH extends DragItemAdapter.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    protected List<WordItem> mItemList;
    //protected List<WordItem> wordItems;
    ...
    public void setItemList(List<WordItem> itemList) {
        mItemList = itemList;
        notifyDataSetChanged();
    }

    public List<WordItem> getItemList() {
        return mItemList;
    }
    ...
    public void addItem(int pos, WordItem item) {
    ...
    public void changeItemPosition(int fromPos, int toPos) {
        if (mItemList != null && mItemList.size() > fromPos && mItemList.size() > toPos) {
            WordItem item = mItemList.remove(fromPos);
    ...
    public static abstract class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView, int handleResId, boolean dragOnLongPress) {
            ...
            Log.d("SwipeWords","dragOnLogPress?"+(dragOnLongPress ? "TRUE": "FALSE"));
